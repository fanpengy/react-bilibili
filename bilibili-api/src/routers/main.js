...
const partitionData2 = {
  0: [
    {tid: 1, typename: "动画"},{tid: 3, typename: "音乐"}
  ],
  1: [
    {tid: 33, typename: "MAD·AMV"}
  ],
  13: [],
  167: [
    {tid: 153, typename: "国产动画"}, {tid: 168, typename: "国产原创相关"}, {tid: 169, typename: "布袋戏"},
...
const partitionData = {
  0: [
    {tid: 1, typename: "互联网"}, {tid: 2, typename: "社科"}, {tid: 3, typename: "经济"},
    {tid: 4, typename: "音乐"}, {tid: 5, typename: "生活"}
  ],
  1: [
    {tid: 11, typename: "数据库"}, {tid: 12, typename: "后端开发"}, {tid: 13, typename: "前端开发"},
    {tid: 14, typename: "运维"}, {tid: 15, typename: "网络"}, {tid: 16, typename: "操作系统"}
  ],
  2: [
  ...
  5: [
    {tid: 51, typename: "美食"}, {tid: 52, typename: "健身"}, {tid: 53, typename: "运动"}
  ],
}
